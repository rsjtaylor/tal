    ...
    function(Device, TransitionEndPoints)  {
        ...
        Device.prototype.tweenElementStyle = function(options) {
            ...
            function getTweenOptions(){
                ...
                for(i = 0; i !== properties.length; i += 1) {
                    property = properties[i];
                    tweenOptions.to[property] = parseFloat(endPoints.getPropertyDestination(property), 10);
                    tweenOptions.from[property] = parseFloat(endPoints.getPropertyOrigin(property), 10);
                }
                return tweenOptions;
            }
